            ...
            while i < 9:
                if i == 0 and k == 0:
                    ...
                    if randVal <= weight * bellCurveVal(currentPoint.z, zLen):
                        ...
                        #print("Weight: ", weight * bellCurveVal(currentPoint.z, zLen))
                        # Set node type
...
# print("Dr Bell", bellCurveVal(0, 5))

for i in range(0, x):
    print(.4 * bellCurveVal(i, x))
